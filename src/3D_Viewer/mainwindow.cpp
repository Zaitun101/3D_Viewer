...
{
    QString file = QFileDialog::getSaveFileName(this, tr("Save as..."), "../saved/name.jpeg",  tr("JPEG (*.jpeg)"));
...
{
    QString file = QFileDialog::getSaveFileName(this, "Save as...", "../saved/name.bmp",  tr("BMP (*.bmp)"));
    ui->GLwidget->grabFrameBuffer().save(file, NULL, 100);
}
...
void MainWindow::on_save_record_released()
{
    QString str = QFileDialog::getSaveFileName(
          this, tr("Save GIF"), "../saved", tr("GIF (*.gif)"));
      if (str != "") {
        QGifImage giF(QSize(790, 660));
